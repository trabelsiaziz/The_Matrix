...
def mutate(offspring: Individual):
    """
...
def cross_over(
    ...
    offspring_one_genome = torch.tensor(genome_one[:cross_over_point] + genome_two[cross_over_point:])
    offspring_two_genome = torch.tensor(genome_two[:cross_over_point] + genome_one[cross_over_point:])
